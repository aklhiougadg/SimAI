...
namespace MockNccl {
  ...
  ncclInfo* MockNcclGroup::get_algo_proto_info(
    ...
    // v2.20 baseline: protocol field is dead (not consumed by ns3 datapath).
    // Always set to UNDEF here. The SIMAI_PROTO_AWARE switch is v2.30-only;
    // see SimCCL/mock/v2.30/MockNcclGroup.cc.
